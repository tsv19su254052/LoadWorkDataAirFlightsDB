...
if config_from_cfg.getboolean(section='ConstantParameters', option='DebugLevel') and config_from_cfg.get(section='UserLogins', option='Developer') == str(os.getlogin()):
