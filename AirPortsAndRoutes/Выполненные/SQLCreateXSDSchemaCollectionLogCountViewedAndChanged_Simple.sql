...
CREATE XML SCHEMA COLLECTION SchemaLogCountViewedAndChanged_Simple AS '
...
PRINT 'Привязал сводную XSD-схему к базе в коллекцию dbo.SchemaLogCountViewedAndChanged_Simple'
GO
